function Integrand=TDTR_TEMP_DOUGHNUT_vH4(kvectin,freq,LCTE,r_pump,r_probe,A_pump,xoffset)
%TDTR_TEMP_DOUGHNUT_vH4 - For beam offset measurements, computes frequency 
