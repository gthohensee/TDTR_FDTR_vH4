function [Psol,fitOK] = VoutLinearFit_vH4(DATAMATRIX)
%VoutLinearFit_vH4 - Assists user in specifying a linear fit to the V(out)
...
%
% [Psol,fitOK] = VoutLinearFit_vH4(DATAMATRIX)
%
% Inputs:
...
%
% See also: SetPhase_vH4.m, extract_interior.m
