function [LCTE, T_LCTE] = writeLCTE_vH4(stack, thickness,Xijc,P,T0,refdir,rho_Al)
...
% 
% Syntax:  writeLCTE_vH4(stack, thickness,Xijc,P,T0,refdir,rho_Al)
%
% Inputs:
...
if ~exist('rho_Al','var') || isempty('rho_Al'), rho_Al = -1; end
...
%% TRANSDUCER ABSORPTION LAYERS % % % % % % % % % % % % % % % % % % % % %
            case '*' % absorption layer cases
                ...
                switch ss
                    ...
                    case 'au' % gold
                        abslayer = 100; % I don't know, but it's large.
...
%% OTHER MATERIALS % % % % % % % % % % % % % % % % % % % % % % % % % % % %
            ...
            case 'ni' % polycrystalline nickel
                ...
                C(ii) = 3.95e6;
            case 'cr'
                    lambda(ii) = 50; % 93.9 bulk, 50 by 4-point-probe.
                    C(ii) = 7140 * 449;
            case 'pmma'
                lambda(ii) = 0.18;
                C(ii) = 2e6;
            ...
            case 'sto' % SrTiO3, or "STO"
                lambda(ii) = 8; % from Olav Hellwig's measurement
                C(ii) = 2.74e6; % from Cahill's website, 300 K.
            case 'indium'
                lambda(ii) = 81;
                C(ii) = 1.68e6;
