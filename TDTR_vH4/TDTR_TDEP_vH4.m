function [dTss, dTpp, LCTE] = TDTR_TDEP_vH4(matparams,sysparams,...
...
%    --
%
% Other m-files required: TDTR_TEMP_vH4.m, SS_Heating_vH4.m
% Subfunctions: none
% MAT-files required: none
%
% See also: TDTR_TDEP_TTM_vH4.m
...
dTss = SS_Heating_vH4(matparams,r_pump,r_probe,absC_at_T,A_tot,intscheme,nnodes);
if perpulse
...
while (dTerr > 0.01) % Loop until dT converges to within 1%. Doesn't take many iterations.
    ...
    % recompute dT_SS
    dTss_new = SS_Heating_vH4(matparamstemp,r_pump,r_probe,absC_at_T,A_tot,intscheme,nnodes);
    if perpulse
