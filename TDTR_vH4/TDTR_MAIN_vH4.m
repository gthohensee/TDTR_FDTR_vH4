%TDTR_MAIN_vH4 - Given system & thermal parameters, do thermal modeling.
...
if ebar
    ...
    [kErr_perc, kErr_abs, ...
        ...
        errorbars_vH4(Xijc,datparams,sysparams,...
...
if importdata
    TDTR_MAIN_IMPORT_vH4; % Input: tdelay, datadir, datain, mid, sigfit, 
    ...
    TDTR_MAIN_FIT_vH4; % Uses signal_data and offset arrays to execute fit,
