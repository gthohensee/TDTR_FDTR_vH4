%INITIALIZE_CELLPARAMS_vH4 - Unpacks cell arrays into variables for the
...
%    spinning - TRUE if sample is moving under beam (offset is function of
%               tdelay).
%
%
...
%                   3-Sep-2015  - introduce spinning sample option.
%                   11-Jul-2016  - vH4.
%------------- BEGIN CODE --------------
