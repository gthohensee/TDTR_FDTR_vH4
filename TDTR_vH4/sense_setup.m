%sense_setup - Template for calling parametric_senseplot_vH4.
%
% Inputs:
%    none
%
% Outputs
%    See outputs of parametric_senseplot_vH4.
%
% Other m-files required: parametric_senseplot_vH4.m
% Subfunctions: none
% MAT-files required: none
%
% See also: sense_setup_retro.m, parametric_senseplot_vH4.m
...
f=8.05e6; % pump laser modulation frequency, Hz
...
frac = 0.21; % if psc, fractional change in pump spot change over 
...
thickness = [50 1    400      300 500e3]; % thickness in nm of each model layer
stack = {'Ru', '/','Au24K','SiO2','Si'}; % identifier for each model layer
...
[LCTE,T_LCTE] = writeLCTE_vH4(stack, thickness,Xijc,P0,T0,refdir,rho_Al);
...
[S_LCTE,S_sys,xvar,SS_LCTE,SS_sys] = ...
    parametric_senseplot_vH4_notN(Xij,SYS_i, xvar, ...
