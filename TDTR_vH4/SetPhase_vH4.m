function [delphase,phase,fitparam] = SetPhase_vH4(data,t0,filename,pathname,t_window)
%SetPhase_vH4 - Adjust the phase defining V(in) and V(out) in DATA matrix.
...
%do this efficiently.
%
% Syntax:  [delphase,phase,fitparam] = SetPhase_vH4(data,t0,filename,pathname,t_window)
%
% Inputs:
...
% Example:
%    [delphase, phase] = SetPhase_vH4(data,-0.3,filename,pwd, [-20 80])
%
